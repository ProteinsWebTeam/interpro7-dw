...
def gen_tasks(config: dict) -> list[Task]:
    ...
    tasks = [
        ...
        Task(
            ...
            name="export-matches",
            requires=["export-proteins"],
            scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=10000, hours=36),
        ),
        Task(
    ...
    mysql_tasks = [
        Task(
            fn=interpro.mysql.entries.populate_annotations,
        ...
        Task(
            fn=interpro.mysql.entries.index_annotations,
            args=(ipr_stg_uri,),
        ...
        Task(
            fn=interpro.mysql.clans.populate,
        ...
        Task(
            fn=interpro.mysql.databases.populate_databases,
        ...
        Task(
            fn=interpro.mysql.entries.populate_entries,
            args=(
                ipr_stg_uri,
                df.clans,
                df.entries,
        ...
        Task(
            fn=interpro.mysql.entries.index_entries,
            args=(ipr_stg_uri,),
            name="index-entries",
        ...
        Task(
            fn=interpro.mysql.entries.populate_entry_taxa_distrib,
        ...
        Task(
            fn=interpro.mysql.proteins.populate_features,
        ...
        Task(
            fn=interpro.mysql.proteins.index_features,
            args=(ipr_stg_uri,),
            name="index-features",
        ...
        Task(
            fn=interpro.mysql.proteins.populate_isoforms,
        ...
        Task(
            fn=interpro.mysql.proteins.populate_residues,
        ...
        Task(
            fn=interpro.mysql.proteins.index_residues,
            args=(ipr_stg_uri,),
            name="index-residues",
        ...
        Task(
            fn=interpro.mysql.proteins.populate_proteins,
            args=(
                ipr_stg_uri,
                df.clans,
                df.entries,
        ...
        Task(
            fn=interpro.mysql.proteins.index_proteins,
            args=(ipr_stg_uri,),
            name="index-proteins",
        ...
        Task(
            fn=interpro.mysql.proteomes.populate,
        ...
        Task(
            fn=interpro.mysql.proteomes.index,
            args=(ipr_stg_uri,),
        ...
        Task(
            fn=interpro.mysql.structures.populate_structures,
            args=(
                ipr_stg_uri,
                df.structures,
                df.uniprot2pdb,
        ...
        Task(
            fn=interpro.mysql.taxa.populate,
        ...
        Task(
            fn=interpro.mysql.databases.populate_rel_notes,
            args=(
                ipr_stg_uri,
                ipr_rel_uri,
                df.clans,
    ...
    ftp_files_tasks = [
        ...
        Task(
            ...
            name="ftp-uniparc",
            requires=["export-uniparc"],
            scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=40000, hours=48),
        ),
    ]
