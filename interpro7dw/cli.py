...
def gen_tasks(config: configparser.ConfigParser) -> list[Task]:
    ...
    tasks = [
        ...
        Task(fn=interpro.oracle.proteins.export_uniparc_proteins,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=1000, hours=4)),
        ...
        Task(fn=interpro.oracle.matches.export_features,
             ...
             requires=["export-proteins"],
             scheduler=dict(type="scheduler", queue=queue, cpu=8, mem=4096, hours=10)),
        Task(fn=interpro.oracle.matches.export_uniprot_matches,
             args=(ipr_pro_uri, df.proteins, df.protein2matches),
             kwargs=dict(processes=8, tempdir=temp_dir),
             name="export-matches",
             requires=["export-proteins"],
             scheduler=dict(type="scheduler", queue=queue, cpu=8, mem=8000, hours=22)),
        ...
        Task(fn=interpro.oracle.matches.export_uniparc_matches,
             ...
             scheduler=dict(type="scheduler", queue=queue, cpu=8, mem=16000, hours=23)),
    ...
    xrefs_tasks = [
        Task(fn=interpro.xrefs.domorgs.export,
             ...
             requires=["export-matches"],
             scheduler=dict(type="scheduler", queue=queue, cpu=16, mem=16000, hours=4)),
        ...
        Task(fn=interpro.xrefs.entries.export_xrefs,
             ...
             requires=["export-alphafold", "export-proteomes",
                       ...
                       "export-evidences"],
             scheduler=dict(type="scheduler", queue=queue, cpu=16, mem=24000, hours=12)),
        Task(fn=interpro.xrefs.proteomes.export_xrefs,
             ...
             scheduler=dict(type="scheduler", queue=queue, cpu=16, mem=24000, hours=2)),
    ...
    tasks += [
        ...
        Task(fn=interpro.oracle.lookup.build_matches_table,
             ...
             name="lookup-matches",
             requires=["lookup-md5"],
             scheduler=dict(type="scheduler", queue=queue, mem=4000, hours=18)),
    ...
    mysql_tasks = [
        Task(fn=interpro.mysql.entries.populate_annotations,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=5000, hours=4)),
        ...
        Task(fn=interpro.mysql.clans.populate,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=2000, hours=4)),
        ...
        Task(fn=interpro.mysql.entries.populate_entry_taxa_distrib,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=8000, hours=9)),
        Task(fn=interpro.mysql.proteins.populate_features,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=1000, hours=16)),
        Task(fn=interpro.mysql.proteins.index_features,
             args=(ipr_stg_uri,),
             name="index-features",
             requires=["insert-features"],
             scheduler=dict(type="scheduler", queue=queue, hours=6)),
        ...
        Task(fn=interpro.mysql.proteins.populate_residues,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=1000, hours=9)),
        ...
        Task(fn=interpro.mysql.proteins.populate_proteins,
             ...
             requires=["export-clans", "export-entries", "export-isoforms",
                       ...
                       "export-sequences"],
             scheduler=dict(type="scheduler", queue=queue, mem=8000, hours=28)),
        Task(fn=interpro.mysql.proteins.index_proteins,
             args=(ipr_stg_uri,),
             name="index-proteins",
             requires=["insert-proteins"],
             scheduler=dict(type="scheduler", queue=queue, hours=13)),
        ...
        Task(fn=interpro.mysql.structures.populate_structures,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=8000, hours=2)),
        Task(fn=interpro.mysql.taxa.populate,
             args=(ipr_stg_uri, df.taxa, df.taxon2xrefs),
             name="insert-taxa",
             requires=["export-taxon2xrefs"],
             scheduler=dict(type="scheduler", queue=queue, mem=4000, hours=9)),
        Task(fn=interpro.mysql.taxa.index,
             args=(ipr_stg_uri,),
             name="index-taxa",
             requires=["insert-taxa"],
             scheduler=dict(type="scheduler", queue=queue, hours=5)),
        Task(fn=interpro.mysql.databases.populate_rel_notes,
             ...
             scheduler=dict(type="scheduler", queue=queue, mem=12000, hours=11),
    ...
    es_tasks = [
        Task(fn=interpro.elastic.export_documents,
             ...
             requires=["export-dom-orgs", "export-proteomes",
                       ...
                       "export-taxa"],
             scheduler=dict(type="scheduler", queue=queue, mem=30000, hours=52))
    ]
    ...
    for cluster, hosts, cluster_dir in es_clusters:
        es_tasks += [
            ...
            Task(
                ...
                scheduler=dict(type="scheduler", queue=queue, mem=8000, hours=72),
    ...
    service_tasks = [
        Task(
            ...
            scheduler=dict(type="scheduler", queue=queue, mem=20000, hours=27),
        ...
        Task(
            ...
            name="export-goa",
            scheduler=dict(type="scheduler", queue=queue, mem=8000, hours=5),
    ...
    exchange_tasks = service_tasks + [
        ...
        Task(fn=interpro.ftp.xmlfiles.export_interpro,
             ...
             requires=["export-entries", "export-entry2xrefs",
                       "export-databases"],
             scheduler=dict(type="scheduler", queue=queue, mem=10000, hours=5)),
        Task(fn=interpro.ftp.xmlfiles.export_matches,
             ...
             requires=["export-databases", "export-isoforms",
                       "export-matches"],
             scheduler=dict(type="scheduler", queue=queue, cpu=8, mem=24000, hours=22)),
        ...
        Task(fn=interpro.ftp.uniparc.archive_matches,
             ...
             scheduler=dict(type="scheduler", queue=queue, cpu=8, mem=10000, hours=33)),
    ]
    ...
    tasks += [
        Task(
            ...
            scheduler=dict(type="scheduler", queue=queue, hours=3),
