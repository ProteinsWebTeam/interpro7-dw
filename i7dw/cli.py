...
def build_dw():
    ...
    tasks = [
        ...
        Task(
            ...
            scheduler=dict(queue=queue, mem=10000, scratch=20000, cpu=4),
        ...
        Task(
            ...
            kwargs=dict(processes=4, tmpdir="/scratch"),
            scheduler=dict(queue=queue, mem=2000, scratch=35000, cpu=4),
            requires=["chunk-proteins"]
        ),
        Task(
        ...
        Task(
            ...
            kwargs=dict(processes=4, tmpdir="/scratch"),
            scheduler=dict(queue=queue, mem=8000, scratch=3000, cpu=4),
            requires=["chunk-proteins"]
        ),
        Task(
            # TODO: check it completes
            ...
            kwargs=dict(processes=4, tmpdir="/scratch"),
            scheduler=dict(queue=queue, mem=8000, scratch=1000, cpu=4),
            requires=["chunk-proteins"]
        ),
        Task(
