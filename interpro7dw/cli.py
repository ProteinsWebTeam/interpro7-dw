...
def gen_tasks(config: configparser.ConfigParser) -> list[Task]:
    ...
    tasks = [
        ...
        Task(fn=interpro.oracle.proteins.export_matches,
             args=(ipr_pro_uri, df.protein2matches),
             name="export-matches",
             scheduler=dict(mem=1000, queue=lsf_queue)),
        ...
        Task(fn=interpro.oracle.proteins.export_uniparc,
             args=(ipr_pro_uri, df.protein2uniparc),
             name="export-uniparc",
             scheduler=dict(mem=4000, queue=lsf_queue)),
        ...
        Task(fn=interpro.oracle.structures.export_structural_models,
             args=(ipr_pro_uri, df.structmodels),
        ...
        Task(fn=interpro.oracle.proteins.export_sequences,
             ...
             requires=["export-proteins"],
             scheduler=dict(mem=2000, tmp=60000, queue=lsf_queue)),
    ...
    insert_tasks = [
        ...
        Task(fn=interpro.mysql.proteins.populate_proteins,
             args=(ipr_stg_uri, df.clans, df.isoforms, df.structures,
                   df.protein2structures, df.taxa, df.proteins,
             ...
             requires=["export-clans", "export-isoforms", "export-structures",
                       "export-structure-chains", "export-taxa",
