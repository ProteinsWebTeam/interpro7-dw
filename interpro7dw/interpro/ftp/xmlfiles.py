...
def export_toad_matches(
    ...
    with gzip.open(output, "wt", encoding="utf-8") as fh:
        ...
        fh.write(
            f"""\
<!--
Copyright {date.today():%Y} Google LLC

The materials are licensed under the Creative Commons Attribution 4.0 \
International License (CC-BY). You may obtain a copy of the CC-BY license at: \
https://creativecommons.org/licenses/by/4.0/legalcode

Unless required by applicable law or agreed to in writing, \
all materials distributed here under the CC-BY licenses are distributed \
