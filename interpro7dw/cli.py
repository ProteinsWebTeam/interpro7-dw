...
def gen_tasks(config: dict) -> list[Task]:
    ...
    tasks = [
        ...
        Task(
            fn=alphafold.export,
            args=(config["data"]["alphafold"], df.proteins, df.protein2alphafold),
        ...
        Task(
            fn=interpro.oracle.matches.export_features,
            args=(ipr_pro_uri, df.proteins, df.protein2features),
            kwargs=dict(processes=8, tempdir=temp_dir),
            name="export-features",
            requires=["export-proteins"],
            scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=4096, hours=12),
        ),
        Task(
        ...
        Task(
            ...
            name="export-toad",
            requires=["export-proteins"],
            scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=8000, hours=24),
        ),
        Task(
            fn=interpro.oracle.hmms.export_hmms,
        ...
        Task(
            fn=interpro.oracle.proteins.export_uniprot_sequences,
        ...
        Task(
            fn=uniprot.proteins.export_entry2functions,
        ...
        Task(
            fn=uniprot.proteins.export_entry2name,
        ...
        Task(
            fn=uniprot.proteins.export_entry2proteome,
    ...
    tasks += [
        ...
        Task(fn=wait, name="export", requires=get_terminals(tasks)),
    ]

    xrefs_tasks = [
        Task(
            fn=interpro.xrefs.domorgs.export,
        ...
        Task(
            fn=interpro.xrefs.entries.export_sim_entries,
        ...
        Task(
            fn=interpro.xrefs.clans.export_xrefs,
            args=(
                df.clans,
                df.proteins,
                df.protein2matches,
            ...
            scheduler=dict(type=scheduler, queue=queue, cpu=16, mem=32000, hours=6),
        ),
        Task(
            ...
            kwargs=dict(
                interpro_uri=ipr_pro_uri if update_db else None,
                processes=16,
                tempdir=temp_dir,
            ),
            ...
            scheduler=dict(type=scheduler, queue=queue, cpu=16, mem=100000, hours=24),
        ),
        Task(
            fn=interpro.xrefs.proteomes.export_xrefs,
            args=(
                df.proteins,
                df.protein2matches,
                df.protein2proteome,
            ...
            scheduler=dict(type=scheduler, queue=queue, cpu=16, mem=100000, hours=6),
        ),
        Task(
            fn=interpro.xrefs.structures.export_xrefs,
            args=(
                df.clans,
                df.proteins,
                df.protein2proteome,
        ...
        Task(
            fn=interpro.xrefs.taxa.export_xrefs,
            args=(
                df.proteins,
                df.protein2matches,
                df.protein2proteome,
    ...
    tasks += [
        ...
        Task(
            ...
            name="lookup-matches",
            requires=["export-uniparc"],
            scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=50000, hours=120),
        ),
        Task(
            fn=interpro.oracle.lookup.create_sites_table,
            args=(ips_pro_uri, uniparc_dir),
            kwargs=dict(processes=8),
            name="lookup-sites",
            requires=["export-uniparc"],
    ...
    mysql_tasks = [
        Task(
            ...
            requires=["export-entries", "export-hmms", "export-pfam-alignments"],
            scheduler=dict(type=scheduler, queue=queue, mem=5000, hours=6),
        ),
        Task(
            fn=interpro.postgresql.entries.index_annotations,
            args=(ipr_stg_uri,),
        ...
        Task(
            fn=interpro.postgresql.clans.populate,
        ...
        Task(
            fn=interpro.postgresql.databases.populate_databases,
        ...
        Task(
            fn=interpro.postgresql.entries.populate_entries,
            args=(
                ipr_stg_uri,
                df.clans,
                df.entries,
            ...
            requires=[
                ...
                "export-entry2xrefs",
                "export-structures",
                "export-pfam-families",
            ],
            scheduler=dict(type=scheduler, queue=queue, mem=10000, hours=3),
        ),
        Task(
            fn=interpro.postgresql.entries.index_entries,
            args=(ipr_stg_uri,),
            name="index-entries",
        ...
        Task(
            fn=interpro.postgresql.entries.populate_entry_taxa_distrib,
        ...
        Task(
            fn=interpro.postgresql.proteins.populate_features,
        ...
        Task(
            fn=interpro.postgresql.proteins.index_features,
            args=(ipr_stg_uri,),
            name="index-features",
        ...
        Task(
            fn=interpro.postgresql.proteins.populate_isoforms,
        ...
        Task(
            fn=interpro.postgresql.proteins.populate_residues,
        ...
        Task(
            fn=interpro.postgresql.proteins.index_residues,
            args=(ipr_stg_uri,),
            name="index-residues",
        ...
        Task(
            fn=interpro.postgresql.proteins.populate_proteins,
            args=(
                ipr_stg_uri,
                df.clans,
                df.entries,
        ...
        Task(
            fn=interpro.postgresql.proteins.index_proteins,
            args=(ipr_stg_uri,),
            name="index-proteins",
        ...
        Task(
            fn=interpro.postgresql.proteomes.populate,
        ...
        Task(
            fn=interpro.postgresql.proteomes.index,
            args=(ipr_stg_uri,),
        ...
        Task(
            fn=interpro.postgresql.structures.populate_structures,
            args=(
                ipr_stg_uri,
                df.structures,
                df.uniprot2pdb,
        ...
        Task(
            fn=interpro.postgresql.taxa.populate,
        ...
        Task(
            fn=interpro.postgresql.taxa.index,
            args=(ipr_stg_uri,),
            name="index-taxa",
        ...
        Task(
            fn=interpro.postgresql.proteins.populate_toad_matches,
        ...
        Task(
            fn=interpro.postgresql.proteins.index_toad_matches,
            args=(ipr_stg_uri,),
            name="index-toad",
        ...
        Task(
            fn=interpro.postgresql.databases.populate_rel_notes,
            args=(
                ipr_stg_uri,
                ipr_rel_uri,
                df.clans,
    ...
    es_tasks = [
        Task(
            fn=interpro.elastic.export_documents,
            args=(
                df.proteins,
                df.protein2matches,
                df.protein2domorg,
            ...
            scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=48000, hours=24),
        ),
    ]
    ...
    for cluster in es_clusters:
        es_tasks += [
            ...
            Task(
                ...
                scheduler=dict(type=scheduler, queue=queue, cpu=8, mem=16000, hours=96),
    ...
    ftp_files_tasks = [
        Task(
            fn=interpro.ftp.flatfiles.export,
        ...
        Task(
            fn=interpro.ftp.xmlfiles.export_interpro,
        ...
        Task(
            fn=interpro.ftp.xmlfiles.export_toad_matches,
        ...
        Task(
            fn=interpro.ftp.relnotes.export,
        ...
        Task(
            fn=interpro.ftp.uniparc.archive_matches,
...
def build():
    ...
    parser.add_argument("config", metavar="config.toml", help="configuration file")
    group = parser.add_mutually_exclusive_group()
    group.add_argument(
        "-t", "--tasks", nargs="*", default=None, metavar="TASK", help="tasks to run"
    )
    group.add_argument(
        "-a",
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="list tasks to run and exit"
    )
    parser.add_argument(
        "--detach", action="store_true", help="enqueue tasks to run and exit"
    )
    try:
...
def update_pronto_state():
    ...
    parser.add_argument(
        "--freeze-on",
        metavar="DATETIME",
        help="Update the next freeze date (format:"
        "<year>-<month>-<day>T<hour>:<minute>, e.g. 2025-02-21T19:00)",
    )
    parser.add_argument("config", metavar="config.toml", help="configuration file")
    args = parser.parse_args()
    ...
    uri = config["databases"]["interpro"]["production"]
